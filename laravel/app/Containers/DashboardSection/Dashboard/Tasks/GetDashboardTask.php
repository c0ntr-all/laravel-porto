...
class GetDashboardTask extends ParentTask
{
     ...
     */
    public function run(Dashboard $dashboard, array $with = []): Dashboard
    {
        return $this->dashboardRepository->find($dashboard, $with);
    }
}
