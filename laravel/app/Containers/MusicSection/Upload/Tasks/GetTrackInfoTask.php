...
class GetTrackInfoTask extends ParentTask
{
     ...
     * @throws \Exception
     */
    public function run(string $trackPath): array
    {
        return $this->getTrackInfo($trackPath);
    }
    ...
    /**
     * Get all necessary tags with using ID3
     *
     * @param string $path
     * @return array
     */
    ...
    /**
     * Convert track duration into 00:05:34, instead 05:34:00
     *
    ...
    /**
     * Convert date into Y-m-d format, if only year(Y) was sent
     *
